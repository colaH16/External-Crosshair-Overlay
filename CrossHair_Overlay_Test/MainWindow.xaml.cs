...
namespace External_Crosshair_Overlay
{
    ...
    public partial class ECO_MainGUI : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            mHook = new MouseHook();
            //mHook.StartHook(crosshairOverlayWindow);
            mHook.StartHook(crosshairOverlayWindow, sldr_Opacity.Value);
        }
        ...
        private void CrosshairTransparency_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            ...
            //mHook.SetTransparency = (double)e.NewValue;
        }
        ...
        private void AttachingToProcessComplete(string processName, string processFilePath)
        {
            Dispatcher.Invoke(() =>
            {
                ...
                if (processName != "None")
                {
                    var config = configSaver.GetConfig(processName, processFilePath);
                    ...
                    mHook.SetTransparency = sldr_Opacity.Value;
        ...
        private void btn_saveConfig_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                FileName = lbl_attachTo.Content.ToString(),
